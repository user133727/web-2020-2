    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if not current_user.can(action,record=record):
                flash('Not enough rights to access this page', 'danger')
    ...
    if request.method == 'POST':
        ...
        if login and password:
            ...
            if db_user:
                ...
                flash('You are successfully authenticated!', 'success')
...
def init_login_manager(app):
    ...
    login_manager.login_message = 'To access this page, you must pass authentication!'
